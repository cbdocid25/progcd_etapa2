...
Treina três modelos supervisionados de classificação com o dataset 
creditcard.csv, compara suas métricas de desempenho 
(Accuracy, Precision, Recall, F1-Score, ROC-AUC) e salva os resultados 
em um arquivo CSV chamado resultados_modelos.csv.
...
df_resultados.to_csv("dataset/metricas_treinamento.csv", index=False)
